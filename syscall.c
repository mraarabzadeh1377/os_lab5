...
extern int sys_addProcessToPriorityQueue(void);
extern int sys_addProcessToFCFSQueue(void);
extern int sys_addProcessToLattaryQueue(void);
...
static int (*syscalls[])(void) = {
    ...
    [SYS_addProcessToPriorityQueue] sys_addProcessToPriorityQueue,
    [SYS_addProcessToFCFSQueue] sys_addProcessToFCFSQueue,
    [SYS_addProcessToLattaryQueue] sys_addProcessToLattaryQueue,
